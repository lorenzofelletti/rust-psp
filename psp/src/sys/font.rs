...
pub enum SceFontErrorCode {
    Success = 0,
    OutOfMemory = 0x8046_0001,
    InvalidLibId = 0x8046_0002,
    InvalidParameter = 0x8046_0003,
    NoFile = 0x8046_0004,
    HandlerOpenFailed = 0x8046_0005,
    HandlerCloseFailed = 0x8046_0006,
    HandlerReadFailed = 0x8046_0007,
    HandlerSeekFailed = 0x8046_0008,
    TooManyOpenFonts = 0x8046_0009,
    InvalidFontData = 0x8046_000A,
    InconsistentData = 0x8046_000B,
    Expired = 0x8046_000C,
    Registry = 0x8046_000D,
    NoSupport = 0x8046_000E,
    Unknown = 0x8046_FFFF,
}
